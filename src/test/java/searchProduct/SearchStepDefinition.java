...
public class SearchStepDefinition {
	...
	@Then("I click on my product")
	public void iClickOnMyProduct() {
		searchPageObject.clickImgProduct();
	}

	@Then("the search result should display {string}")
	public void theSearchResultShouldDisplay(String expectedMessage) {
