...
And je clique sur le bouton Continuer
Then un message d'erreur s'affiche en haut de la page en rouge "Impossible de trouver un compte correspondant à cette adresse e-mail
...
And je saisi le mot de passe "2015.codeamazon@"
And je clique sur le bouton S'identifier
Then un message d'erreur s'affiche en haut de la page en rouge "un probleme est survenu votre mot de passe est incorrecte"
